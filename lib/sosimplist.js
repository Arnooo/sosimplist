...
function Sosimplist() {
    /** @private */
    this.sosimplistId_ = new Date().getTime();
    this.viewId_ = '';
    this.view_ = null;
    this.mapOfList_ = {};
...
Sosimplist.prototype.init = function(viewId) {
    try {
        ...
        this.view_.className += 'sosimplist';
        ...
        this.listContainer_.id = 'sosimplist-container-list'+this.sosimplistId_;
        this.listContainer_.className = 'sosimplist-container-list';
...
Sosimplist.prototype.clearAll = function() {
    try {
        ...
        var el = document.getElementById('sosimplist-container-list'+this.sosimplistId_);
        while (el.firstChild) {
